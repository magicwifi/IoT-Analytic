...
if __name__=='__main__':
    ...
    #sql_create1 = "CREATE TABLE sensor_hour_max_min(date varchar(32) NOT NULL, hour integer NOT NULL, deviceid varchar(32) NOT NULL, sensor varchar(32) NOT NULL, max float NOT NULL, min float NOT NULL, avg float NOT NULL, primary key(date, hour, deviceid, sensor))"
    ...
    #sql_create1 = "CREATE TABLE sensor_max_min(date varchar(32) NOT NULL,deviceid varchar(32) NOT NULL,sensor varchar(32) NOT NULL,max float NOT NULL, min float NOT NULL,avg float NOT NULL, primary key(date, deviceid, sensor))"
